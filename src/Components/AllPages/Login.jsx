...
const Login = () => {
  const { login, setUser, loading, GmailLogin, githubLogin, twitterLogin, user } = useContext(AuthContext);
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)]">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 border-4 mx-auto  ">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button className=" btn btn-primary block w-full p-3 text-center rounded-md dark:text-gray-50 dark:bg-violet-600">Sign in</button>
        </form>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button onClick={handleTwitterLogin} aria-label="Log in with Twitter" className="p-3 rounded-sm">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-600">
          ...
          <Link to="/register" rel="noopener noreferrer" className="underline dark:text-gray-800">
            Sign up
          </Link>
        </p>
      </div>
